...
class ParticleFilter {  
 public:
  ...
  // calculates multivariant Gaussian probability
  double multivProb(double sig_x, double sig_y, double x_obs, double y_obs, double mu_x, double mu_y);

  // returns corresponding nearest landmark to the observation
  Map::single_landmark_s getLandmarkForObservation(const LandmarkObs &currentObservation, 
                                    const Map &map_landmarks); 
